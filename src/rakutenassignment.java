 ...
 * Step 4: Exceptions are handled by using try and catch block. Also the error message to enter 12 digits 
 * is displayed if the productID is not of 12 digits.
 */
public class rakutenassignment {
	...
	public static String converttoISBN(Long productID) {
		...
		if(id.length()==12) {
			...
			return "Please enter a valid 12 digit";
		}
			...
			return ("Exception"+ e +" has occured");
		}
	}
